...
public class IA_Movimiento : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        StartCoroutine(CheckEnemyMoving()); //Empezar la coorutina
    ...
    //Hacer que rote el personaje en el movimiento
    IEnumerator CheckEnemyMoving()
    {
        ...
        {
            PersonajeEnemigo.flipX = true;
        }
        else if (transform.position.x < actualPos.x)
        {
            PersonajeEnemigo.flipX = false;
        }
